...
// ßæÏ ÊÔÛíá æÊÈÏíá ÇáæÖÚ ÇáÏÇßä (Dark Mode)
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (themeBtn) {
        themeBtn.addEventListener('click', () => {
            // ÅÖÇÝÉ Ãæ ÅÒÇáÉ ßáÇÓ ÇáÏÇÑß ãæÏ ãä ÇáÌÓã ÇáÑÆíÓí ááãæÞÚ
            document.body.classList.toggle('dark-theme');

            // ÊÛííÑ ÇáäÕ ÏÇÎá ÇáÒÑ ÍÓÈ ÇáæÖÚ ÇáÍÇáí
